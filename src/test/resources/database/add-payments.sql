...
INSERT INTO payments (id, status, type, rental_id, session_url, session_id, amount)
VALUES
(1, 'PENDING', 'PAYMENT', 1, 'https://checkout.stripe.com/pay/cs_test_123', 'cs_test_123', 450.00);